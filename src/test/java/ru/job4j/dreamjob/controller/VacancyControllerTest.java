...
public class VacancyControllerTest {
    ...
    public void whenRequestVacancyGetByIdThenGetPageWithVacancy() {
        ...
        when(vacancyService.findById(id)).thenReturn(Optional.of(vacancy1));
    ...
    public void whenPostVacancyUpdateThenRedirectToVacanciesPage() throws Exception {
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancy = new Vacancy(2, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenPostVacancyDeleteThenRedirectToVacanciesPage() {
        int id = 1;
