...
class CandidateControllerTest {
    ...
    public void whenRequestCandidateGetByIdThenGetPageWithCandidate() {
        int id = 1;
        var candidate1 = new Candidate(id, "test1", "desc1", now(), true, 1, 2);
    ...
    public void whenPostCandidateUpdateThenRedirectToCandidatesPage() throws Exception {
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var candidate = new Candidate(2, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenSomeExceptionUpdateThrownThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Failed to write file");
    ...
    @Test
    public void whenPostCandidateDeleteThenRedirectToCandidatesPage() {
        int id = 1;
